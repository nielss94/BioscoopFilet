...
public class TrailerApiConnector extends AsyncTask<String, Void, String> {

    private TrailerAvailable listener = null;

    public TrailerApiConnector(TrailerAvailable listener) {
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            for (int i = 0; i < films.length(); i++) {
                ...
                if (film.getString("type").equals("Trailer")) {

                    finalURL = "https://www.youtube.com/watch?v=" + film.optString("key");
                    //Callback
                    listener.trailerAvailable(finalURL);
                    break;
                }
            }
